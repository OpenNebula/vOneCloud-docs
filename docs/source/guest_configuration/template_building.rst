...
.. note:: There are more options that can be set in the contextualization section. You can read about them in the :onedoc:`Virtual Machine Definition File reference section <operation/references/template.html#template-context>`
