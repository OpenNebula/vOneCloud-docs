...
.. warning::
    If you make **any** changes to OpenNebula configuration files under ``/etc/one`` please note that they **will** be discarded and overwritten in the next vOneCloud upgrade, except for those listed in this section.
